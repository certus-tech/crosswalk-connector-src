...
import com.jctal.buzzard.cerif.datamodel.schema.Cdm;
import com.jctal.buzzard.cerif.datamodel.schema.Field;
import com.jctal.buzzard.util.MiscUtils;
import com.jctal.buzzard.util.StandaloneJaxbUtil;
...
public class CanonicalDataModel {
   ...
   * Path to the CDM XML.
   */
  private static final String CDM_XML_FILE_PATH = "com/jctal/buzzard/cerif/datamodel/CanonicalDataModel.xml";
  /**
   * Path to the CDM XSD.
   */
  private static final String CDM_XSD_FILE_PATH = "com/jctal/buzzard/cerif/datamodel/CanonicalDataModel.xsd";
  /**
   * The CDM XSD package.
   */
  private static final String CDM_XSD_PACKAGE = "com.jctal.buzzard.cerif.datamodel.schema";
  /**
