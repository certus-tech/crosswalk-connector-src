 ...
 */
package com.jctal.buzzard.cerif.datamodel;

import com.jctal.buzzard.cerif.datamodel.schema.Field;
import com.jctal.buzzard.util.DefaultFileData;
import com.jctal.buzzard.util.FileData;
import com.jctal.buzzard.util.MiscUtils;
import com.jctal.buzzard.util.processor.Processor.ExitStatus;
import com.jctal.buzzard.util.processor.ProcessorReturn;
import com.jctal.buzzard.util.processor.xml.SchemaValidateProcessor;
import com.jctal.buzzard.util.xml.XMLPrettyPrint;
import com.jctal.xmlupdate.xquf.XQUFEngine;
...
public class CDMToCERIF {
   ...
   */
  private static final String CERIF_XML_EMPTY = "<CERIF date=\"%s\" "
  + "sourceDatabase=\"com.jctal.buzzard\" xmlns=\"urn:xmlns:org:eurocris:cerif-1.6-2\"></CERIF>";
  /**
   * CDM fields.
   */
  ...
  public void initialise() throws Exception {
    if (engine == null) {
      ...
      props.load(classLoader.getResourceAsStream("com/jctal/buzzard/cerif/datamodel/CDMToCERIF.properties"));
      ...
      && dataValues.containsKey(field.getName())) {
        try {
          ...
          if (logger.isDebugEnabled()) {
            logger.debug("Failed to serialise data as CERIF: " + data + ", field:" + field.getName(), e);
          }
          logger.error("Failed to serialise data as CERIF. Field:" + field.getName(), e);
          throw e;
        }
      }
    }
  ...
  private void validateCERIF(byte[] cerifXml) throws Exception {
    ...
    processor.setSchemaClasspath("com/jctal/buzzard/cerif/CERIF_1.6_2.xsd");
  ...
  private String getQueryExpression(Field field) throws IOException {
    ...
    if (xqufStr == null) {
      String path = "com/jctal/buzzard/cerif/datamodel/" + field.getName() + ".xquf";
